...
def collision_blake2b():
	trials = 0
	while True:

		randstr1 = ''.join(random.choices(string.ascii_letters + string.digits + string.punctuation, k = 5))
